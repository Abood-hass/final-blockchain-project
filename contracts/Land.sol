...
contract Land {
    ...
    function registerSeller(address _sellerId, string memory _name, uint _age, string memory _aadharNumber, string memory _panNumber, string memory _landsOwned, string memory _document) public {
